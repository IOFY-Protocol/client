...
export const RentHome = () => {
    ...
    useEffect(() => {
        getIoTDevice(7549).then((device) => {
            console.log('getIoTDevice', device);
        });
        getAllDevicesId().then(r => {
            console.log('getAllDevicesId', r);
        });
        getAllDevicesInfo().then(res => {
            console.log('getAllDevicesInfo', res);
        });
    }, []);
    return (
